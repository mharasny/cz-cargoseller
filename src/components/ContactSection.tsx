...
const ContactSection = () => {
  return <footer id="kontakt" className="flex w-full max-w-[1520px] flex-col items-center bg-[#4D4D4D] mt-[316px] pt-20 pb-[33px] px-20 rounded-2xl max-md:max-w-full max-md:mt-10 max-md:px-5 scroll-mt-24">
      <div className="flex w-[1200px] max-w-full flex-col items-stretch">
          ...
          <div className="min-w-60 w-[262px] pt-10">
            <div className="w-full text-lg text-white font-normal leading-none">
              <div className="flex w-full items-center gap-6 text-xl text-[#66BC98] font-bold leading-[1.2]">
                <img src={accountClientIcon} alt="Customer service" className="w-[54.757px] h-[60px] shrink-0 my-auto" style={{
                aspectRatio: '54.76/60.00'
              }} />
            ...
            <div className="w-full mt-10">
              <div className="flex w-full items-center gap-6 text-xl text-[#66BC98] font-bold leading-[1.2]">
                <img src="https://api.builder.io/api/v1/image/assets/73b29f1caf414e8dadec59a4cd659ee3/6f7d3686a43e9d0627be3cb78db65263afcf8d1f?placeholderIfAbsent=true" alt="Technical support" className="aspect-[0.92] object-contain w-[55px] self-stretch shrink-0 my-auto rounded-[0px_0px_0px_0px]" />
                <div className="text-zielony font-roboto-condensed text-[20px] font-bold leading-6 self-stretch my-auto">
                  Technická podpora
                </div>
              </div>
              <div className="flex w-full items-center gap-[30px] text-lg text-white font-normal whitespace-nowrap leading-none mt-2 px-2">
                <img src="https://api.builder.io/api/v1/image/assets/73b29f1caf414e8dadec59a4cd659ee3/573edd57d2ef8bb863fa8f396a662fc36f23f6ed?placeholderIfAbsent=true" alt="Email" className="aspect-[0.93] object-contain w-[37px] self-stretch shrink-0 my-auto rounded-[0px_0px_0px_0px]" />
                <div className="text-white self-stretch my-auto">
        ...
        <div className="flex items-center gap-3 flex-wrap mt-[41px] max-md:max-w-full max-md:mt-10">
          <div className="self-stretch flex min-h-[47px] items-center gap-[5px] text-[26px] text-white font-bold uppercase w-[183px] my-auto">
            <img src="https://api.builder.io/api/v1/image/assets/73b29f1caf414e8dadec59a4cd659ee3/f4d1657f756163aa1f4d9f16efed3ebac187a116?placeholderIfAbsent=true" alt="CARGOseller logo" className="aspect-[1] object-contain w-[47px] self-stretch shrink-0 my-auto rounded-lg" />
            <div className="self-stretch w-[115px] my-auto">
              <span style={{
              fontFamily: 'Barlow Condensed, -apple-system, Roboto, Helvetica, sans-serif',
              color: '#FFF',
              fontSize: '26px',
              fontWeight: '700',
          ...
          <div className="text-white font-roboto-condensed text-lg font-normal leading-6 self-stretch w-[821px] my-auto pl-5 max-md:max-w-full">
            Digitální nástroje a integrace s burzami k vaší
            dispozici. Využijte je k prodeji spotových nákladů rychleji,
            pohodlněji, efektivněji.
          </div>
        </div>
